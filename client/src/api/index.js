...
export const fetchCitPostsBySearch2 = (searchCitQuery) => API.get(`/cit2/search?searchCitQuery=${searchCitQuery.search || 'none'}`)
...
export const fetchCiePostsBySearch2 = (searchCieQuery) => API.get(`/cie2/search?searchCieQuery=${searchCieQuery.search || 'none'}`)
...
export const fetchCafaPostsBySearch2 = (searchCafaQuery) => API.get(`/cafa2/search?searchCafaQuery=${searchCafaQuery.search || 'none'}`)
...
export const fetchClaPostsBySearch2 = (searchClaQuery) => API.get(`/cla2/search?searchClaQuery=${searchClaQuery.search || 'none'}`)

      ...
      <Toolbar className={classes.toolbar}>
        {user?.result ? (
          <div className={classes.profile}>
            ...
            <Button variant="contained" className={classes.back} color="secondary" onClick={back}>back to StudentModule</Button>
          </div>
        ) : (
          <React.Fragment>
          <Button component={Link} to="/auth" variant="contained" color="primary">Sign In</Button>
          <Button component={Link} to="/" variant="contained" color="primary">back to Login Page</Button>
          </React.Fragment>
        )}
      </Toolbar>
    </AppBar>
